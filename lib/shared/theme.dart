...
const kPrimaryBlue = Color(0xFF2A4E63);
const kGreen = Color(0xFF3D8A6E);
const kOrange = Color(0xFFC4823A);
const kRed = Color(0xFFB35E4D);

const kPaper = Color(0xFFF7F3EC);
const kSealRed = Color(0xFFC24E40);
const kInkSecondary = Color(0xFF716757);
const kPaperCard = Color(0xFFFEFBF5);
...
ThemeData buildAppTheme() {
  ...
  final textTheme = baseTextTheme.copyWith(
    ...
    bodySmall: const TextStyle(fontFamily: 'NotoSansSC', color: kInkSecondary),
  );
  ...
  return ThemeData(
    ...
    cardTheme: CardThemeData(
      ...
      shadowColor: const Color(0xFF8B7D6B).withValues(alpha: 0.08),
    ...
    navigationBarTheme: NavigationBarThemeData(
      ...
      indicatorColor: kPrimaryBlue.withValues(alpha: 0.1),
      surfaceTintColor: Colors.transparent,
    ...
    progressIndicatorTheme: const ProgressIndicatorThemeData(color: kSealRed),
