...
class _LaunchScreenState extends ConsumerState<LaunchScreen>
  ...
  void initState() {
    ...
    _sealOffset = Tween<Offset>(
      begin: const Offset(26, -28),
      end: Offset.zero,
    ).animate(
      CurvedAnimation(
        parent: _controller,
  ...
  Widget build(BuildContext context) {
    ...
    final titleText = settings['institution_name']?.trim().isNotEmpty == true
        ? settings['institution_name']!.trim()
        : kDefaultInstitutionName;
    final mottoText = settings['institution_motto']?.trim().isNotEmpty == true
        ? settings['institution_motto']!.trim()
                                    ...
                                    child: Stack(
                                      ...
                                      children: [
                                        Align(
                                          ...
                                          child: Opacity(
                                            opacity: 0.22 + (_mottoOpacity.value * 0.2),
                                            child: Transform.scale(
                                              scale: 0.96 + (_inkBloom.value * 0.08),
                                              child: Container(
                                                ...
                                                decoration: BoxDecoration(
                                                  ...
                                                  gradient: RadialGradient(
                                                    colors: [
                                                      ...
                                                      kInkSecondary.withValues(alpha: 0.05),
                                                      Colors.transparent,
                                                    ],
                                        ...
                                        Align(
                                          ...
                                          child: Padding(
                                            ...
                                            child: Column(
                                              ...
                                              children: [
                                                Transform.translate(
                                                  offset: Offset(0, _titleDrift.value),
                                                  child: Opacity(
                                                    opacity: _titleOpacity.value,
                                                    child: _BrushRevealText(
                                                      text: titleText,
                                                      progress: _titleReveal.value,
                                                      style: TextStyle(
                                                        fontFamily: 'MaShanZheng',
                                                        fontSize: titleSize,
                                                        letterSpacing: compact ? 4.5 : 6.5,
                                                        height: 1.15,
                                                ...
                                                Transform.translate(
                                                  offset: Offset(0, _mottoDrift.value),
                                                  child: Opacity(
